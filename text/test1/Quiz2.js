const questions = [
    {
        question: "In Python 3, what is the output of type(range(5)). (What data type it will return): ",
        optionA: "int",
        optionB: "list",
        optionC: "range",
        optionD: "none",
    ...
    {
        question: "What is the data type of the following: aTuple = (1, 'Jhon', 1+3j) print(type(aTuple[2:3]))",
        optionA: "list",
        optionB: "complex",
        optionC: "tuple",
        optionD: "set",
    ...
    {
        question: "What is the output of the given code : print(bool(0), bool(3.14159), bool(-3), bool(1.0+1j))",
        optionA: "False True False True",
        optionB: "True True False True",
        optionC: "True True False True",
        optionD: "False True True True",
        correctOption: "optionD"
    },
