const questions = [
    {
        question: "The unexpected event happened during program execution should be handled byhich of the following is incorrect file handling mode in Python",
        optionA: "EXCEPTION",
        optionB: "ASSERTION",
        optionC: "EXPERIMENT",
        optionD: "NONE",
    ...
    {
        question: "Exception disrupts the",
        optionA: "Normal flow of the program",
        optionB: "Abnornal flow of the program",
        optionC: "Hard Disk",
    ...
    {
        question: "An exception can be manually triggered by the command",
        optionA: "raise",
        optionB: "try",
        optionC: "except",
        optionD: "trigger",
    ...
    {
        title: "________ statement can also be used without specifying Exception.",
        optionA: "Try",
        optionB: "Except",
        optionC: "Finally",
        optionD: "Else",
    ...
    {
        question: "The suspicious code is put inside the",

        optionA: "Try Block",
        optionB: "Finally Block",
        optionC: "Else Block",
        optionD: "Except Block",
        correctOption: "optionA"
    },
