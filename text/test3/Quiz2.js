const questions = [
    {
        question: "Which of the following is incorrect file handling mode in Python",
        optionA: "wb+",
        optionB: "ab",
        optionC: "xr",
        optionD: "ab+",
    ...
    {
        question: "What is the output of print('[%c]' % 65): ",
        optionA: "65",
        optionB: "A",
        optionC: "[A]",
        optionD: "Syntax error",
        correctOption: "optionC"
    },
    ...
    {
        title: "Which of the following is incorrect file handling mode in Python.: ",
        optionA: "r",
        optionB: "x",
        optionC: "t+",
        optionD: "b",
...

    {
        ...
        optionA: "create a file if the specified file does not exist",
        optionB: "Create a file, returns an error if the file exists",
        optionC: "Create a file if it doesnot exists else Truncate the existed file",
