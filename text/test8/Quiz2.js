const questions = [
    {
        question: "Which brackets are used to create Lists?",
        optionA: "()",
        optionB: "{}",
        optionC: "[]",
        optionD: "none",
...

    {
        ...
        optionA: "To add a new item to a specified position in the list.",
        optionB: "To delete the item specified.",
        optionC: "To find the index of a specific item.",
        optionD: "To add a new item to the end of the list.",
...

    {
        ...
        optionA: "To add a new item to a specified position in the list.",
        optionB: "To find the index of a specific item.",
        optionC: "To add a new item to a specified position in the list.",
        optionD: "To delete the item specified.",
        correctOption: "optionB"
    },

    {
        title: "Which of the following function is used to count the number of elements in a list ?",
        optionA: "count( )",
        optionB: "find( )",
        optionC: "len( )",
        optionD: "index( )",
    ...
    {
        question: "What is the index of “grape” in the list [“apple”, “grape”, “orange”, “watermelon”]?",
