const questions = [
    ...
    {
        question: "Select the correct output of the following String operations ? str1 = 'Welcome'    print (str1[:6] + ' PYnative')",
        optionA: "Welcome PYnative",
        optionB: "WelcomPYnative",
        optionC: "Welcom PYnative",
        optionD: "WelcomePYnative",
        correctOption: "optionC"
    },
    ...
    {
        title: "What is the result of this statement? print(ord('foo'))",
        optionA: "324",
        optionB: "102 111 111",
        optionC: "102",
        optionD: "It raises an exception",
        correctOption: "optionD"
    },

    {
        question: "Suppose s is assigned as follows: s = 'foobar'? All of the following expressions produce the same result except one. Which one?",

        optionA: "s[::-5]",
        optionB: "s[::-1][::-5]",
        optionC: "s[0] + s[-1]",
        optionD: "s[::-1][-1] + s[len(s)-1]",
